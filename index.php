	...
	<!--Import Google Icon Font-->
      ...
      <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
      	<style type="text/css">
	       ...
	       body {
	          background: url(images/logincok.png) no-repeat fixed;
				...
				<div class="col s12 m12 l6 offset-l3 card-panel z-depth white">
					...
					<div class="row">
						<div class="col s12 m12 l12 center">
							<input name="login" type="submit" value="Masuk" class="modal-action modal-close waves-effect waves-light btn black darken-2">
						</div>
                  	</div>
