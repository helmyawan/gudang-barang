		                ...
		                <li>
		                	...
		                	<div class="collapsible-body">
		                		<ul>
									...
									<li class="active blue darken-4"><a>Barang Keluar</a></li>
								</ul>
							</div>
		                </li>
				...
				<div class="col s12 m12 l12 offset-l2"> <br>
					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						...
						<table>
							<tr>
				            	<td colspan='9'>
				            		<a href='tambah-barang-keluar.php' class="right waves-effect waves-light btn blue darken-2">Tambah Barang<i class="material-icons right">add</i></a>
				            	</td>
				            </tr>
						</table>
					</div>
