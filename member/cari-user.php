		            ...
		            <ul class="collapsible collapsible-accordion">
		                ...
		                <li>
		                	...
		                	<div class="collapsible-body">
		                		<ul>
		                			<li class="active blue darken-4"><a href="user.php">User</a></li>
					...
					<div class="col s12 m12 l12">
						<form name="cari" method="post" action="" class="row">
	                    	<div class="e-input-field col s12 m12 l12">
	                    		<input type="text" name="cari" placeholder="Cari Berdasarkan Nama / NIK / Telepon / Status / Devisi / Email " class="validate" required title="Cari User">
					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							<?php 
			                    ...
			                    $cari = $_POST['cari'];
			                    $sql = "SELECT * FROM users WHERE id LIKE '%$cari%' OR nik LIKE '%$cari%' OR nama LIKE '%$cari%' OR alamat LIKE '%$cari%' OR telepon LIKE '%$cari%' OR level LIKE '%$cari%' OR divisi LIKE '%$cari%' OR email LIKE '%$cari%'";
