...
session_start();
  ...
  $user = "localhost";
  $name = "id10337265_inventori";
  $pass = "12345";
  $dbname = "id10337265_inventori";
		            ...
		            <ul class="collapsible collapsible-accordion">
		                ...
		                <li>
		                	...
		                	<div class="collapsible-body">
		                		<ul>
		                			<li><a href="user.php">User Aktif</a></li>
									<li><a href="barangmasuk.php">Barang Masuk</a></li>
									<li><a href="gudang.php">Stock Gudang</a></li>
				...
				<div class="col s12 m12 l9 offset-l3">
					...
					<div class="col s12 m6 l6">
		                <div class="card blue-grey lighten-5">
		                    <div class="card-content black-text text-darken-2">
			                    <span class="card-title">User Aktif
			                        <p class="right"><?php echo $jml; ?></p>
			                    </span>
		                    </div>
		                    
		                    <div class="card-action">
		                    	<i class="material-icons left black-text text-darken-2">visibility</i>
		                    	<a href="user.php" class="black-text text-darken-2">Lihat</a>
		                    </div>
		                </div>
	                </div>
					...
					<div class="col s12 m6 l6">
		                <div class="card blue-grey lighten-5">
		                    ...
		                    <div class="card-action">
		                    	<i class="material-icons left black-text text-darken-2">visibility</i>
		                    	<a href="barangmasuk.php" class="black-text text-darken-2">Lihat</a>
		                    </div>
		                </div>
	                </div>
					...
					<div class="col s12 m6 l6">
		                <div class="card blue-grey lighten-5">
		                    <div class="card-content black-text text-darken-2">
			                    <span class="card-title">Stock Gudang
		                    ...
		                    <div class="card-action">
		                    	<i class="material-icons left black-text text-darken-2">visibility</i>
		                    	<a href="gudang.php" class="black-text text-darken-2">Lihat</a>
		                    </div>
		                </div>
	                </div>
					...
					<div class="col s12 m6 l6">
		                <div class="card blue-grey lighten-5">
		                    ...
		                    <div class="card-action">
		                    	<i class="material-icons left black-text text-darken-2">visibility</i>
		                    	<a href="barangkeluar.php" class="black-text text-darken-2">Lihat</a>
		                    </div>
		                </div>
	                </div>
