	...
	<div class="row">
		            ...
		            <ul class="collapsible collapsible-accordion">
		                ...
		                <li>
		                	...
		                	<div class="collapsible-body">
		                		<ul>
		                			<li class="active blue darken-4"><a>User</a></li>
        ...
        <?php
          ...
          if(isset($_POST['tambah'])) {
            ...
            $result = mysqli_query($koneksi, "INSERT INTO users(nik,nama,alamat,telepon,divisi,email,username,password,level) VALUES('$nik','$name','$alamat','$telepon','$divisi','$email','$username','$password','$level')");
